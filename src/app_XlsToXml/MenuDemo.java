...
public class MenuDemo implements ActionListener, ItemListener {
    ...
    public JMenuBar createMenuBar() {
        ...
        menu.getAccessibleContext().setAccessibleDescription("Context description");
        menuBar.add(menu);

        //a group of JMenuItems
        menuItem = new JMenuItem("Generate Utrancell Files", KeyEvent.VK_T);

        //menuItem.setMnemonic(KeyEvent.VK_T); //used constructor instead
        menuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_1, ActionEvent.ALT_MASK));
        //menuItem.getAccessibleContext().setAccessibleDescription("Context description");
        menuItem.addActionListener(this);
        menu.add(menuItem);

       // ImageIcon icon = createImageIcon("images/middle.gif");
        menuItem = new JMenuItem("Generate 2ndCarrier UtranRelations");
